...
},plugins:["location","datepicker","radiobox","checkbox","draggable","droppable","resizable","pagination","tooltip","linkbutton","menu","menubutton","splitbutton","progressbar","tree","textbox","filebox","combo","combobox","combotree","combogrid","numberbox","validatebox","searchbox","spinner","numberspinner","timespinner","datetimespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","treegrid","tabs","accordion","window","dialog","form"],parse:function(_2){
var aa=[];
...
(function($) {
	function createLocation(target) {
		...
		$provBox = $('<div id="'+opts.provId+'" class="location-address '+opts.provClass+'"><input type="text" name="'+opts.provName+'"/></div>').appendTo($target);
		...
		if (opts.showCity) {
			$cityBox = $('<div id="'+opts.cityId+'" class="location-address '+opts.cityClass+'"><input type="text" name="'+opts.cityName+'"/></div>').appendTo($target);
		...
		if (opts.showRegion && opts.showCity) {
			$regionBox = $('<div id="'+opts.regionId+'" class="location-address '+opts.regionClass+'"><input type="text" name="'+opts.regionName+'"/></div>').appendTo($target);
